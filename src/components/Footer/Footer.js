...
import footerLogo from '../../assets/images/FieldX.png';
            ...
            <footer className="footer footer-center p-10 text-primary-content">
                <div>
                    ...
                    <p className="font-normal text-primary">
                        Sed ut perspiciatis unde omnis iste natus error sit voluptatem <br /> accusantium doloremque laudantium, totam rem aperiam eaque.
                    </p>
                ...
                <div className='border-t border-base-100 w-full pt-7 mt-7'>
                    <p className='text-primary'>&copy; All rights reserve by <span className='text-red-500'>MAAC</span></p>
                </div>
            </footer>
        </div>
    );
